...
const interfaceKeys = [
  "nexora:dashboards", "nexora:views", "nexora:todayWidgets",
...
test("les tableaux de bord et les vues enregistrées sont fusionnables", () => {
  // Ce sont des listes d'objets portant un id : deux postes qui modifient deux
  // tableaux différents doivent voir leurs deux modifications survivre.
