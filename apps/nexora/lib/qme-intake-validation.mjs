...
export function escapeMarkdown(value) {
  ...
  return value
    // Caractères de contrôle (hors saut de ligne \n, conservé pour "message").
    .replace(/[\u0000-\u0009\u000b\u000c\u000e-\u001f]/g, "")
    // Neutralise l'ouverture de toute balise HTML/XML.
    .replace(/</g, "\\<")
    .replace(/>/g, "\\>")
    // Échappe les caractères actifs CommonMark en tête ou n'importe où dans
    // le champ (titres, listes, emphase, liens, code, citations).
    .replace(/([\\`*_{}[\]()#+\-.!|>~])/g, "\\$1");
}
